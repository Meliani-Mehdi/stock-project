...
public class Product {
    ...
    public Product(Integer id, String codebar, String reference, String name, Double buying_Price, Double selling_Price, Integer stock, String depots, String groupe) {
        Id = id;
        Codebar = codebar;
        Reference = reference;
        this.name = name;
